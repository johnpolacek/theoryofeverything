...
export const metadata: Metadata = {
  title: "Appendix A: Logic — Holos (⊛) Formal Structure | a Theory of Everything",
  description:
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || "https://yourdomain.com"}/appendix-a`,
  },
  openGraph: {
    title: "Appendix A: Logic — Holos (⊛) Formal Structure",
    description:
      "A formal mathematical and philosophical structure defining Holos (⊛) through primitive definitions, axioms, foundational propositions, and extrapolative propositions.",
    url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://yourdomain.com"}/appendix-a`,
