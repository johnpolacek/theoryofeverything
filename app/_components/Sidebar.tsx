...
const predictionsSubsections: Subsection[] = [
  ...
  { id: "experiment-protocol-observer-dependent-coherence-preservation", title: "Experiment Protocol" },
]
              ...
              <>
                {theorySubsections.map((subsection) => (
                  <li key={subsection.id}>
                    {subsection.id === "holos" ? (
                      <a className="flex items-center gap-1 -ml-0.5 pb-2" href={getLink(`#${subsection.id}`)}>
