  ...
  return (
    <main>
      ...
      <Section id="consciousness" title="Consciousness">
        <p>
        Consciousness is the ability to experience and shape the world with
        self-awareness.
        </p>
        <p>
      ...
      <Section id="higher-dimensions" title="Higher Dimensions">
        <p>
        Though we can't directly observe higher dimensions, mathematical models
        suggest their existence, offering solutions to longstanding problems in
        physics.
        </p>
        <p>
