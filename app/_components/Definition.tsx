  ...
  return (
    <div className="flex flex-col gap-12 max-w-[50rem]">
      <div className="prose prose-lg max-w-none">
        ...
        <p>
          <strong>Integration:</strong> Measures the information loss when the system is partitioned
        ...
        <p>
          Where <MathInline>{"P(ψ_i)"}</MathInline> is the standard probability of the outcome (the
          Born Rule).
        </p>
        ...
        <ol>
          <li>
            <strong>The Probability (The Coin Flip):</strong> The likelihood of any specific outcome
            (Heads vs. Tails) remains purely random, governed by the standard laws of quantum
            probability (<MathInline>{"|ψ|^2"}</MathInline>). Consciousness does not "force" a
            specific result.
          </li>
          <li>
            <strong>The Actualization (The Landing):</strong> <MathInline>{"Φ"}</MathInline> acts as
            the filtering condition that allows the "coin" to land at all. The "real" branch is the
            one where the observer possesses sufficient integrated information to register the
            event. Without <MathInline>{"Φ"}</MathInline>, the system remains in a superposition of
