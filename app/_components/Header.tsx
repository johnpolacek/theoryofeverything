export default function Header() {
  return (
    <header id="home" className="relative p-8 lg:px-16 border-b border-black/20 border-dashed xl:h-[160px] animate">
      <img src="/icon.svg" alt="Holos" title="Holos" className="w-6 h-6 absolute top-3 left-3 lg:w-8 lg:h-8 xl:hidden" />
